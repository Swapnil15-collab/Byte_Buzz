...
<section class="about__achievements">
    <div class="container about__achievements-container">
        ...
        <div class="about__achievements-right">
            <h1>Achievements</h1>
            <p>"At ByteBuzz, we are dedicated to empowering computer science students with high-quality study material, interactive resources, and practical learning tools. Our milestones reflect our passion for supporting learners and helping them excel in their academic and professional journeys."</p>
            <div class="achievements__cards">
                <article class="achievement__card">
                   ...
                   <p>"10+ step-by-step tutorials for coding languages."</p>
                ...
                <article class="achievement__card">
                    ...
                    <h4>Students</h4>
                    <p>100+ Engaged students actively learning and excelling through our resources.</p>
                 </article>

                 <article class="achievement__card">
                    <span class="achievement__icon" >
                        <i class="uil uil-file-alt"></i> <!-- This represents an exam paper icon -->

                    </span> 
                    <h4>Exam Papers</h4>
                    <p>20+ Previous question papers for better preparation.
                    </p>
                 </article>
            </div>
        </div>
